...
We'll implement a command-line client for the module created in our [Rust Module Quickstart](quickstart.) or [C# Module Quickstart](quickstart6.) guides. Make sure you follow one of these guides before you start on this one.
