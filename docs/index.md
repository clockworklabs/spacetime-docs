...
### Host
A SpacetimeDB **host** is a server that runs [databases](#database). You can run your own host, or use the SpacetimeDB maincloud. Many databases can run on a single host.
